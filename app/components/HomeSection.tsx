    ...
    <div className="max-w-5xl mx-auto px-4 py-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
          <button 
            ...
            className="flex flex-col items-center p-6 bg-white rounded-xl shadow hover:shadow-lg border border-gray-100 transition-all focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 w-full"
